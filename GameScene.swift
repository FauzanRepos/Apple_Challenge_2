...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var initialSpawnPoint = CGPoint(x: 96, y: 672)
    ...
    override func didMove(to view: SKView) {
        ...
        leftEdgeMargin = playableWidth * 0.15
        rightEdgeMargin = playableWidth * 0.15
        topEdgeMargin = playableHeight * 0.15
        bottomEdgeMargin = playableHeight * 0.15
        ...
        cellSize = playableWidth / 16 // Adjust divisor based on level width
    ...
    override init(size: CGSize) {
        ...
        lastCheckpoint = CGPoint(x: 20000, y: 20000)
